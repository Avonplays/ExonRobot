...
buttons = [
    [
        InlineKeyboardButton(
            text="⛩ sᴜᴍᴍᴏɴ ᴍᴇ ⛩ ", url=f"t.me/{BOT_USERNAME}?startgroup=new"
        ),
    ],
    [
        InlineKeyboardButton(text=f" ⚡ᴄᴏᴍᴍᴀɴᴅs⚡ ", callback_data="help_back"),
    ...
    [
        ...
        InlineKeyboardButton(text=" sᴜᴘᴘᴏʀᴛ ", url=f"https://t.me/RADICALS19")
    ],
]       
